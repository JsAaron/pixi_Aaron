...
function Input(manager, callback) {
    ...
    //针对pixi库修正
    var button;
    if(button = manager.options.pixi){
         button.mousedown = button.touchstart = function(data){
                self.domHandler(data.originalEvent)
         }
         button.mousemove= button.touchsmove = function(data){
               self.domHandler(data.originalEvent)
         }        
         button.mouseup = button.touchup = function(data){
             self.domHandler(data.originalEvent)
         }
    }else{
       this.init();
